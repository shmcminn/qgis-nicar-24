...
Link to slides: https://docs.google.com/presentation/d/1nSO7wIAaTmoAwh4QxfE_g1LHKTDtOq3O9gKZliqduAY/

Below you can find a practice example to do after the session that uses the same skills we went over. This is from NICAR 22 and the files are located in [atlanta_practice](atlanta_practice/).
